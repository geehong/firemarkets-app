...
// Open Interest (미결제약정) 데이터 API 훅
// export const useOpenInterestData = (assetId, options = {}) => {
//   const {
//     limit = 1000,
//     startDate,
//     endDate,
...
//   return useQuery({
//     queryKey: ['open-interest', assetId, exchange, limit, startDate, endDate],
//     queryFn: async () => {
//       const params = new URLSearchParams({
//         exchange: exchange,
//         limit: limit.toString(),
...
//       const response = await fetch(`/api/v1/crypto/${assetId}/open-interest?${params}`)
//       if (!response.ok) {
