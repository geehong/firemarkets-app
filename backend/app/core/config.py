...
TIINGO_API_KEY_1 = os.getenv("TIINGO_API_KEY_1")
TIINGO_API_KEY_2 = os.getenv("TIINGO_API_KEY_2")
...
def load_and_set_global_configs():
    ...
    GLOBAL_APP_CONFIGS.update({
        ...
        "TIINGO_API_KEY_1": TIINGO_API_KEY_1,
        "TIINGO_API_KEY_2": TIINGO_API_KEY_2,
        "TIINGO_API_KEYS": [TIINGO_API_KEY_1, TIINGO_API_KEY_2],
