...
def test_alpaca_rest_api():
    """Alpaca REST API 테스트"""
    logger.info("=== Alpaca REST API 테스트 시작 ===")
    ...
    try:
        ...
        quote_url = f"{BASE_URL}/v2/stocks/AAPL/quote"
        ...
        # 3. 여러 종목 가격 조회
        logger.info("3. 여러 종목 가격 조회...")
        symbols = ['AAPL', 'MSFT', 'GOOGL', 'TSLA']
        for symbol in symbols:
            quote_url = f"{BASE_URL}/v2/stocks/{symbol}/quote"
            response = requests.get(quote_url, headers=headers)
