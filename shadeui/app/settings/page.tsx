        ...
        <TabsContent value="security">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card>
              ...
              <CardFooter>
                <Button className={buttonVariants({ variant: "outline" })}>Log Out All Other Sessions</Button>
              </CardFooter>
            </Card>
          </div>
        </TabsContent>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-2">
                    ...
                    <Button className={buttonVariants({ variant: "outline" })}>Manage Integrations</Button>
                  </CardContent>
                </Card>
              </div>
              <div className="flex justify-between">
                <Button className={buttonVariants({ variant: "outline" })}>Download Your Data</Button>
                <Button className={buttonVariants({ variant: "destructive" })}>Delete My Account</Button>
              </div>
            </CardContent>
            <CardFooter>
