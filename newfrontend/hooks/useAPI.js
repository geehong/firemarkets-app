...
// Lightweight API hook that returns typed helpers built on top of apiFetch.
// This file intentionally avoids "use client" so it can be imported from
// either client or server code paths as needed.
export default function useAPI() {
  const get = async (path, options = {}) => {
    return apiFetch(path, { ...options, method: options.method ?? "GET" })
  }
...
// 기본 export는 상단의 함수 default export를 사용합니다
