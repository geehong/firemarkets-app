-- =====================================================
-- FireMarkets Database Optimization Script
-- =====================================================
...
-- asset_types 테이블 최적화
CREATE INDEX IF NOT EXISTS idx_asset_types_name ON asset_types(type_name);
CREATE INDEX IF NOT EXISTS idx_asset_types_created ON asset_types(created_at);

-- assets 테이블 최적화 (가장 중요한 인덱스)
CREATE INDEX IF NOT EXISTS idx_assets_type_ticker ON assets(asset_type_id, ticker);
CREATE INDEX IF NOT EXISTS idx_assets_active_type ON assets(is_active, asset_type_id);
CREATE INDEX IF NOT EXISTS idx_assets_exchange ON assets(exchange);
CREATE INDEX IF NOT EXISTS idx_assets_ticker_active ON assets(ticker, is_active);

-- OHLCV 데이터 최적화 (대용량 데이터)
CREATE INDEX IF NOT EXISTS idx_ohlcv_asset_date ON ohlcv_data(asset_id, timestamp_utc);
CREATE INDEX IF NOT EXISTS idx_ohlcv_date_asset ON ohlcv_data(timestamp_utc, asset_id);
CREATE INDEX IF NOT EXISTS idx_ohlcv_interval ON ohlcv_data(data_interval, asset_id);
CREATE INDEX IF NOT EXISTS idx_ohlcv_asset_interval_date ON ohlcv_data(asset_id, data_interval, timestamp_utc);
