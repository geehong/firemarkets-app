...
export default async function BriefNewsDetailPage({ params }: { params: Promise<{ slug: string; locale: string }> }) {
    ...
    return (
        <main className="container mx-auto px-4 py-8 max-w-4xl">
            {/* Breadcrumb - disabled, using global breadcrumb
            <nav className="mb-6 text-sm text-gray-500 dark:text-gray-400">
                <Link href="/" className="hover:text-blue-600">Home</Link>
                <span className="mx-2">/</span>
                <Link href="/news" className="hover:text-blue-600">News</Link>
                <span className="mx-2">/</span>
                <span className="text-gray-700 dark:text-gray-300">단신</span>
            </nav>
            */}
            ...
            <div className="mt-6 text-center">
                <Link href="/news" className="text-blue-600 hover:text-blue-800 dark:text-blue-400">
                    ← 뉴스 목록으로 돌아가기
                </Link>
            </div>
        </main>
