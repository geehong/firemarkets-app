...
export const useDynamicMetadata = (metadataMap: Record<string, any>) => {
  const language = useLocale()

  useEffect(() => {
    const metadata = metadataMap[language] || {}; // Safely get metadata for the current locale
