...
/**
 * BaseTemplate is the core layout component for standard pages.
 * It provides a consistent header, navigation tabs, and optional sidebar.
 */
                                ...
                                <div className={`flex flex-col gap-6 ${header.headerClassName ? 'p-6 md:p-8' : ''}`}>
                                    ...
                                    <div className="space-y-4 relative z-10">
                                        ...
                                        <div className="flex flex-col lg:flex-row lg:justify-between items-start gap-4">
                                            <h1 className={`flex-1 text-2xl md:text-3xl font-black leading-tight ${header.headerClassName ? 'text-white' : 'text-gray-900 dark:text-white'}`}>
                                                {header.title}
                                            </h1>
                                            {header.actions && (
