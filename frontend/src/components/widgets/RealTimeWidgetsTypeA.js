...
const RealTimeWidgetsTypeA = ({ symbols = [] }) => {
  const { data: prices = {}, isLoading: pricesLoading } = useRealtimePricesPg(symbols, 'crypto', {
    refetchInterval: 10000,
  })
  const { data: spark = {}, isLoading: sparkLoading } = useDelaySparklinePg(symbols, '15m', 96, {
