        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              onChange={(e) => updateFormData('status', e.target.value as 'draft' | 'published' | 'private' | 'scheduled')}
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white text-gray-900"
            >
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => updateFormData('post_type', e.target.value as 'post' | 'page' | 'tutorial' | 'news' | 'assets' | 'onchain')}
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white text-gray-900"
            >
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => updateFormData('author_id', e.target.value ? parseInt(e.target.value) : null)}
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white text-gray-900"
              placeholder="작성자 ID"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => updateFormData('category_id', e.target.value ? parseInt(e.target.value) : null)}
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white text-gray-900"
              placeholder="카테고리 ID"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => updateFormData('asset_id', e.target.value ? parseInt(e.target.value) : null)}
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white text-gray-900"
          ...
          <div className="flex space-x-4">
            <div className="flex items-center">
              <input
                type="checkbox"
                checked={formData.sync_with_asset || false}
                onChange={(e) => updateFormData('sync_with_asset', e.target.checked)}
            ...
            <div className="flex items-center">
              <input
                type="checkbox"
                checked={formData.auto_sync_content || false}
                onChange={(e) => updateFormData('auto_sync_content', e.target.checked)}
                className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
              />
              <label className="ml-2 block text-sm text-gray-700">
                자동 콘텐츠 동기화
          ...
          <div className="flex space-x-4">
            <div className="flex-1">
              ...
              <input
                ...
                onChange={(e) => updateFormData('post_parent', e.target.value ? parseInt(e.target.value) : null)}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white text-gray-900"
            ...
            <div className="flex-1">
              ...
              <input
                ...
                onChange={(e) => updateFormData('menu_order', parseInt(e.target.value) || 0)}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white text-gray-900"
                placeholder="메뉴 순서"
              />
            </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => updateFormData('post_password', e.target.value)}
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white text-gray-900"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              onChange={(e) => updateFormData('published_at', e.target.value ? new Date(e.target.value).toISOString() : null)}
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white text-gray-900"
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) => updateFormData('scheduled_at', e.target.value ? new Date(e.target.value).toISOString() : null)}
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white text-gray-900"
            />
          </div>
        </div>
