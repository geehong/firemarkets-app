      ...
      <div className="p-4 space-y-3">
        <div className="grid grid-cols-1 gap-3">
          <div>
            ...
            <select
              value={postType}
              onChange={(e) => onPostTypeChange(e.target.value as 'post' | 'page' | 'tutorial' | 'news' | 'assets' | 'onchain' | 'raw_news' | 'ai_draft_news')}
            ...
            >
              ...
              <option value="raw_news">Raw News</option>
              <option value="ai_draft_news">AI Draft News</option>
