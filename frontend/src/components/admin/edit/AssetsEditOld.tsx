          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {assets.map((asset) => (
              <div
                ...
                className={`p-4 border rounded-lg cursor-pointer transition-colors ${selectedAsset?.id === asset.id
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right">
                    ...
                    <p className={`text-sm ${asset.change_24h >= 0 ? 'text-green-600' : 'text-red-600'
                      }`}>
