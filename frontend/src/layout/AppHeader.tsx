...
const AppHeader: React.FC = () => {
  ...
  return (
    <>
        ...
        <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
            ...
            <div className="hidden lg:flex items-center gap-3">
              <form onSubmit={(e) => {
                ...
                if (inputRef.current?.value) {
                  window.location.href = `/tag/${encodeURIComponent(inputRef.current.value)}`;
                }
              }}>
          ...
          >
            ...
            {isAuthenticated ? (
              ...
              <Link
                href="/signin"
                className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white transition rounded-lg bg-brand-500 hover:bg-brand-600"
              >
                Sign In
              </Link>
            )}
      ...
      <div
        className="hidden w-full px-6 py-2 border-t border-gray-200 dark:border-gray-800 lg:block transition-all duration-300 ease-in-out sticky top-[76px] bg-white dark:bg-gray-900 z-30"
      >
        <DynamicBreadcrumb />
      </div>
    </>
